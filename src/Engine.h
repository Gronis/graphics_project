...
class Engine {
 ...
 private:
  ...
  int updates_per_second_when_sleeping_ = 5;
 ...
 public:
  ...
  /// Get if this engine is sleeping or not
  inline bool sleeping() { return sleeping_; }
  inline void sleeping(bool sleeping) { sleeping_ = sleeping; }
